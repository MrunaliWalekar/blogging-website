...
<head>
  ...
  .navbar {
    ...
    box-shadow: 0 2px 15px rgba(22, 23, 23, 0.1); /* subtle dark shadow */
  ...
  .nav-brand a:hover {
    color: #a67a7a; /* muted dark pink hover */
  }
  ...
  .nav-link:hover,
  .nav-link.active {
    background-color: #161717ff; /* dark background */
    color: #e8d1d1ff; /* soft pink text */
  }
...
<body>
  ...
  <div class="nav-container">
    ...
    <div class="nav-menu">
      ...
      <a href="explore.php" class="nav-link">Posts</a>
